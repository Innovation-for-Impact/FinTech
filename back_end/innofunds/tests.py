...
class FriendshipTestCases(TestCase):
    ...
    def test_update_friendship(self):
        ...
        self.assertFalse(FintechFriend.objects.have_relationship(user1.id, user2.id))
        self.assertFalse(FintechFriend.objects.have_relationship(user2.id, user1.id))
        FintechFriend.objects.create_friendship(user1.id, user2.id)
        self.assertTrue(
            FintechFriend.objects.have_friendship_of_type(user1.id, user2.id, 3)
        )
        self.assertFalse(
            FintechFriend.objects.have_friendship_of_type(user1.id, user2.id, 0)
        )
        self.assertTrue(
            FintechFriend.objects.have_friendship_of_type(user1.id, user2.id, 3)
        )
        ...
        self.assertTrue(FintechFriend.objects.have_relationship(user1.id, user2.id))
        self.assertTrue(FintechFriend.objects.have_relationship(user2.id, user1.id))
        ...
        self.assertTrue(
            FintechFriend.objects.have_friendship_of_type(user1.id, user2.id, 2)
        )
        self.assertFalse(
            FintechFriend.objects.have_friendship_of_type(user1.id, user2.id, 3)
        )
    ...
    def test_get_relationship_type(self):
        ...
        FintechFriend.objects.create_friendship(user1.id, user2.id)
        FintechFriend.objects.create_friendship(user1.id, user3.id)
        user1_relationships = FintechFriend.objects.get_user_relationships(user1.id)
        ...
        user1_relationships = FintechFriend.objects.get_user_relationships(user1.id, 1)
        self.assertIn(2, user1_relationships)
        self.assertNotIn(3, user1_relationships)

        user1_relationships = FintechFriend.objects.get_user_relationships(user1.id, 2)
        self.assertIn(3, user1_relationships)
    ...
    def test_friend_requests(self):
        ...
        self.assertTrue(
            FintechFriend.objects.have_friendship_of_type(user1.id, user2.id, 1)
        )
